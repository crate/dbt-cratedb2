...
class TestPostgresAdapterConversions(AdapterConversions):
    def test_convert_text_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert CrateDBAdapter.convert_text_type(agate_table, col_idx) == expect
    ...
    def test_convert_number_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert CrateDBAdapter.convert_number_type(agate_table, col_idx) == expect
    ...
    def test_convert_boolean_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert CrateDBAdapter.convert_boolean_type(agate_table, col_idx) == expect
    ...
    def test_convert_datetime_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert CrateDBAdapter.convert_datetime_type(agate_table, col_idx) == expect
    ...
    def test_convert_date_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert CrateDBAdapter.convert_date_type(agate_table, col_idx) == expect
    ...
    def test_convert_time_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert CrateDBAdapter.convert_time_type(agate_table, col_idx) == expect
